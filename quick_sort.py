"""
Function to perform quick sort oon array
Input; list
Output: sorted list
"""
def quick_sort(arr):
    ...
    while stack:
        ...
        #if there are items on the left of the pivot, put them on the side
...
def partition(arr, low, high):
    ...
    for j in range(low, high):
        #if the current item is less than or equal too the pivot, swap it with the element at the border
        if arr[j] <= pivot:
            i += 1
